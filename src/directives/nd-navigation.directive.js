 ...
 */
angular.module('directives').directive('ndNavigation', ['$templateCache', '$rootScope', '$state', '$timeout', '$http', '$filter',
  function ($templateCache, $rootScope, $state, $timeout, $http, $filter) {
    return {
      restrict: 'E',
